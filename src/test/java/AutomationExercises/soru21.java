...
public class soru21 extends TestBaseBeforeAfter {
    ...
    public void test1() {
        ...
        //Kullanıcının başarıyla TÜM ÜRÜNLER sayfasına gittiğini doğrulayın
        WebElement verifyAlPrd = driver.findElement(By.xpath("//h2[@class='title text-center']"));
        Assert.assertTrue(verifyAlPrd.isDisplayed());
        //5. Click on 'View Product' button //Ürünü Görüntüle' düğmesine tıklayın
